...
describe('DraftComponent', () => {
  ...
  beforeEach(async () => {
    const draftServiceSpy = jasmine.createSpyObj('DraftService', [
      'getDraftBoardState', 'selectPlayer', 'pauseDraft', 'resumeDraft', 'cancelDraft'
    ]);
  ...
  describe('confirmCancel', () => {
    it('should show confirmation dialog for draft cancellation', () => {
  ...
  describe('getRegionLabel', () => {
    ...
    it('should return correct region label for NAW', () => {
      ...
      expect(result).toBe('North America West');
    });
  ...
  describe('selectPlayer', () => {
    it('should select player successfully', () => {
      ...
      draftService.selectPlayer.and.returnValue(of(true));

      component.selectPlayer(player);
      
      expect(draftService.selectPlayer).toHaveBeenCalledWith('1', '1');
    });
  });
